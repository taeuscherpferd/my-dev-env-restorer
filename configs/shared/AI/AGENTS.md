...
- Make sure to always make small reusable components when architecting. Do not get lazy. Sometimes it's unavoidable, but in most cases individual files should be no more than 100-400 lines of code
